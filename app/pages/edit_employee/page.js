    ...
    return(
      ...
      <div className="w-full bg-white px-6 py-6 border rounded-xl shadow-lg hover:shadow-xl">
          ...
          <form action="/" className="my-2 space-y-5 ">
            ...
            <button
              type="submit"
              className="py-3 px-5 text-md font-medium text-center text-white rounded-lg bg-blue-700 sm:w-fit hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300"
            >
              Update
            </button>
          </form>
